...
- (void)setSubView {
    ...
    _odePassword.placeholder=[NSString stringWithFormat:@"登录原密码"];
    ...
    _nowPassword.placeholder=[NSString stringWithFormat:@"登录新密码"];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex {
    if(buttonIndex == 0) {
        NSLog(@"向服务器发送指令修改登录密码");
        [InstantAlertView showAlert:@"修改登录密码成功"];
    }
}
